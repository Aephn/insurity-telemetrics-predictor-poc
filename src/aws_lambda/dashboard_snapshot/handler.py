...
def generate_snapshot() -> Dict[str, Any]:
    ...
    agg = {"hardBraking":0, "aggressiveTurning":0, "followingDistance":0, "excessiveSpeeding":0, "lateNightDriving":0}
...
def lambda_handler(event, context):  # AWS style
    try:
        ...
        return {"statusCode":200, "headers":{"Content-Type":"application/json"}, "body": json.dumps(snapshot)}
